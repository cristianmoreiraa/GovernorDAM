package TresEnRaya.controler;

import TresEnRaya.vista.Game;
...
import TresEnRaya.ventana.Register;
import TresEnRaya.vista.*;
import TresEnRaya.Conexion.*;
import TresEnRaya.modelo.*;
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    if (opcion == JOptionPane.YES_OPTION) {
                        ...
                        ps = conet.prepareStatement("INSERT INTO tres_en_raya.casino(Nombre, Win, Lose) ºVALUES (?, 0, 0)");
                        ps.setString(1, nombrePerdedor);
                        ps.executeUpdate();
                        JOptionPane.showMessageDialog(null, "Jugador registrado correctamente");
